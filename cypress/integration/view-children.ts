describe('viewchildren', () => {
  ...
  it('viewchildren', () => {
    ...
    cy.get('div.popover-content').eq(0).should('have.text', 'a');
    cy.get('div.popover-content').eq(1).should('have.text', 'b');
    cy.get('div.popover-content').eq(2).should('have.text', 'c');
